...
#define NP2	16		/* Maximum number of additional programming pulses */
...
static int __devinit comcerto_otp_probe(struct platform_device *pdev)
{
#if defined (CONFIG_COMCERTO_OTP_USER)
	misc_register(&comcerto_otp_misc_device);
#endif /* CONFIG_COMCERTO_OTP_USER */

	printk("comcerto_otp_probe.\n");
	return 0;
}

static int __devexit comcerto_otp_remove(struct platform_device *pdev)
{
#if defined (CONFIG_COMCERTO_OTP_USER)
